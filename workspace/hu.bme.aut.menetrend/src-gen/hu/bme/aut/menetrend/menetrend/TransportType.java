 ...
 * <!-- end-user-doc -->
 * @see hu.bme.aut.menetrend.menetrend.MenetrendPackage#getTransportType()
 * @model
 * @generated
 */
public enum TransportType implements Enumerator
{
  ...
  /**
   * The '<em><b>TROLI</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #TROLI_VALUE
   * @generated
  ...
  /**
   * The '<em><b>TROLI</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>TROLI</b></em>' literal object isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @see #TROLI
   ...
   * @ordered
   */
  public static final int TROLI_VALUE = 3;
   ...
   * @ordered
   */
  public static final int HEV_VALUE = 4;
   ...
   * @generated
   */
  private static final TransportType[] VALUES_ARRAY =
    new TransportType[]
    {
      BUS,
      TRAM,
